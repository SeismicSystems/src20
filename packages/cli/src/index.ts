...
// console.log(
//   "keyHash match?",
//   keyHash.toString("hex") === localKeyHash.slice(2),
// );

// console.log("decrypted message:", decrypt(KEY, nonce, ciphertext));

// const sampleKey = randomBytes(32);
// console.log("new key:", sampleKey.toString("hex"));
// console.log("new key hash:", keccak256(sampleKey).toString("hex"));
...
async function main() {
  ...
  attachTransferListener(client);

  contract.write.transfer([client.account.address, 123e16]);
}
