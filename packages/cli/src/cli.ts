...
import { http, type AbiEvent, type Chain, type Hex } from 'viem';
...
export async function attachEventListener(client: ShieldedWalletClient, aesKey: Hex) {
...
async function handleEvent(aesGcmCrypto: AesGcmCrypto, log: any, callback: (data: any) => void) {
