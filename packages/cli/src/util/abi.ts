...
export const IntelligenceAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: '_owner', type: 'address', internalType: 'address' },
      { name: '_keys', type: 'suint256[]', internalType: 'suint256[]' },
    ],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    name: 'addKey',
    inputs: [{ name: '_key', type: 'suint256', internalType: 'suint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    name: 'decrypt',
    inputs: [
      { name: 'key', type: 'suint256', internalType: 'suint256' },
  ...
  },
  {
    type: 'function',
    name: 'encrypt',
    inputs: [{ name: '_plaintext', type: 'bytes', internalType: 'bytes' }],
    outputs: [{ name: '', type: 'bytes[]', internalType: 'bytes[]' }],
    stateMutability: 'nonpayable',
  },
  {
    ...
    name: 'encryptIdx',
    inputs: [
      { name: '_keyIdx', type: 'uint256', internalType: 'uint256' },
      { name: '_plaintext', type: 'bytes', internalType: 'bytes' },
    ],
    outputs: [{ name: '', type: 'bytes', internalType: 'bytes' }],
    stateMutability: 'nonpayable',
  },
  ...
  { type: 'error', name: 'AESPrecompileCallFailed', inputs: [] },
